...
class InMemoryDB {
    ...
    seed() {
        ...
        // Seed Audit Logs
        this.auditLogs.push({ id: 'log_01', admin_id: 'super_admin', action: 'RTP_UPDATED', target_type: 'game', target_id: 'crash', details: { old_rtp: 96, new_rtp: 97 }, created_at: new Date(Date.now() - 3600000 * 4).toISOString() }, { id: 'log_02', admin_id: 'super_admin', action: 'USER_BALANCE_CREDIT', target_type: 'user', target_id: 'usr_101', details: { amount: 5000, reason: 'UPI Manual Bonus' }, created_at: new Date(Date.now() - 3600000 * 2).toISOString() }, { id: 'log_03', admin_id: 'staff_ops', action: 'GAME_MAINTENANCE_TOGGLE', target_type: 'game', target_id: 'dragontower', details: { state: false }, created_at: new Date(Date.now() - 3600000 * 1).toISOString() });
    }
}
